...
try:
    # Em alguns ambientes Windows, o arquivo .env pode ser salvo
    # com uma codificação diferente de UTF-8 (por exemplo UTF-16),
    # o que faz o python-dotenv lançar UnicodeDecodeError.
    # Neste caso, simplesmente ignoramos o .env e confiamos
    # na variável de ambiente do sistema.
